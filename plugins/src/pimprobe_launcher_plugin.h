...
namespace pimprobe {
class PimProbeLauncherPlugin : public PagePluginInterface {
    Q_OBJECT
    Q_PLUGIN_METADATA(IID NESTPAD_PAGE_PLUGIN_IID FILE "PimProbeLauncherPlugin.json")
    Q_INTERFACES(PagePluginInterface)
public:
    PimProbeLauncherPlugin();
    ~PimProbeLauncherPlugin() override;
